...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="pink" data-background-color="pink">
            <div class="logo bg-danger"><a href="./" class="simple-text logo-normal">
                    Zapatería
                </a></div>
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="talla.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="material.php">
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Sistema de Venta STREATWORLD</a>
                    </div>
