                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="laboratorio" class="text-dark font-weight-bold">Material</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="direccion" class="text-dark font-weight-bold">Dureza</label>
                                ...
                                while ($data = mysqli_fetch_assoc($query)) { ?>
                                    <tr>
                                        ...
                                        <td style="width: 200px;">
                                            ...
                                            <form action="eliminar_material.php?id=<?php echo $data['id']; ?>" method="post" class="confirmar d-inline">
