...
$ventas = mysqli_query($conexion, "SELECT d.*, p.id, p.NombreProducto FROM detalle_venta d INNER JOIN producto p ON d.id_producto = p.id WHERE d.id_venta = $id");
...
while ($row = mysqli_fetch_assoc($ventas)) {
    $pdf->Cell(30, 5, $row['NombreProducto'], 0, 0, 'L');
