    ...
    if (empty($_POST['nombre'])) {
        ...
        if (empty($id)) {
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO presentacion(nombre) values ('$nombre')");
                if ($query_insert) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE presentacion SET nombre = '$nombre' WHERE id = $id");
            if ($sql_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="nombre" class="text-dark font-weight-bold">Categoria</label>
